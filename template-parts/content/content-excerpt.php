<div id="post-<?php the_ID(); ?>" <?php post_class( "col-12 col-md-4 block block_link py-20 position-relative overflow-hidden animate__fadeInUp js__fx"); ?>> <a class="block__link" href="<?php the_permalink(); ?>"></a>
  ...
  <div class="block__content">
    <div class="block__image-container overflow-hidden">
      <div class="block__image h-250" style="background-image: url('<?php echo $image[0]; ?>'); background-position:center center; background-size:cover;"> </div>
    </div>
    <?php endif; ?>
    <div class="pt-20">
      <h3>
      ...
      <?php if ( is_category(array( 'design', 'case-study', 'illustration', 'graphicdesign', 'webdesign' ) ) ) { ?>
      <?php
      } else {
        ?>
      <?php the_excerpt(); ?>
