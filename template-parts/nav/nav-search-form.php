<form action="/" method="get" class="d-table w-1-1">
	...
	<div class="d-table-cell align-middle w-50 lh-50">
		<a class="d-block w-50 lh-50 text-center hover:text-tertiary position-relative top-10" data-toggle="collapse" data-target="#search-form" aria-expanded="false" aria-controls="collapse">
