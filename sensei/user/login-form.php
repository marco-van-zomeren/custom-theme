...
<form method="post" name="sensi-login-form" id="loginform" class="login sensei">
	...
	<p class='remember_me d-table'>
		<input class="d-table-cell align-middle" name="rememberme" type="checkbox" id="rememberme" value="forever" /> 
		<label for="rememberme" class="d-table-cell align-middle" style="line-height: 2; padding-left: 5px;"><?php esc_html_e( 'Remember me', 'sensei-lms' ); ?></label>
	</p>
